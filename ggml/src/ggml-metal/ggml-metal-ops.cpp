...
int ggml_metal_op_gated_delta_net(ggml_metal_op_t ctx, int idx) {
    ...
    ggml_metal_kargs_gated_delta_net args = {
        ...
        /*.nb2  =*/ nb2,
        /*.nb3  =*/ nb3,
        /*.nb_out =*/ 0, // upstream GDN_CACHE fusion not used: the prism write-fold path scatters the snapshots
    };
...
int ggml_metal_op_mul_mat(ggml_metal_op_t ctx, int idx) {
    ...
    // the Q1_0 mat-mat threshold (q1_0_mv_max) lives in ggml_metal_op_mul_mat_use_mm (ggml-metal-common.cpp)
    GGML_UNUSED(q1_0_mv_max);
