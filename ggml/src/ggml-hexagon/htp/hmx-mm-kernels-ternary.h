// GluRun M10: Q2_0 / Q1_0 native tiles -> the fp16 32x32 HMX weight tile (prompt processing, n > 4 rows).
// Included by ggml/src/ggml-hexagon/htp/matmul-ops.c after hmx-mm-kernels-tiled.h (patch 0007); tile layout in
