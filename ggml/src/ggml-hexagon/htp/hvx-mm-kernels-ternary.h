// GluRun M10: Q2_0 (ternary, 2-bit) and Q1_0 (1-bit) weights on the Hexagon NPU, HVX mat-vec / small-batch kernels.
// Included by ggml/src/ggml-hexagon/htp/matmul-ops.c after hvx-mm-kernels-flat.h (patch 0007).
//
